    ...
    return {
      items: [
...

        {
          key: "はま浜辺",
          value:
            "はまの活動全般を包括する概念（？）でありYouTubeのチャンネル名でもあります。基本理念は「楽しさ重視」です。",
        },
        {
          key: "Seaside Works.",
          value:
            "はま浜辺と同義です。それっぽい英語の別名が欲しいと思って適当に付けました。英語表記の方がイケてる気がした時に使います。",
        },
        ...
        // },
        {
          key: "アンストッパブル濱本",
          value:
            "稀に登場するはまの別名義です。濱本が止まらない時などに使います。ここだけの話、僕の名前は濱本じゃないです。",
        },
      ],
    };
  },
